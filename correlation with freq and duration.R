...
ggame <- aov(freq$g ~ freq$game) %>% anova_stats()
sqrt(ggame[1,8])
gwgame <- aov(freq$gw ~ freq$game) %>% anova_stats()
sqrt(gwgame[1,8])
ggamehr <- aov(freq$g ~ freq$gamehr) %>% anova_stats()
sqrt(ggamehr[1,8])
gwgamehr <- aov(freq$gw ~ freq$gamehr) %>% anova_stats()
sqrt(gwgamehr[1,8])

ssports <- aov(freq$s ~ freq$sports) %>% anova_stats()
sqrt(ssports[1,8])
swsports <- aov(freq$sw ~ freq$sports) %>% anova_stats()
sqrt(swsports[1,8])
ssportshr <- aov(freq$s ~ freq$sportshr) %>% anova_stats()
sqrt(ssportshr[1,8])
swsportshr <- aov(freq$sw ~ freq$sportshr) %>% anova_stats()
sqrt(swsportshr[1,8])


mmusic <- aov(freq$m ~ freq$music) %>% anova_stats()
sqrt(mmusic[1,8])
mwmusic <- aov(freq$mw ~ freq$music) %>% anova_stats()
sqrt(mwmusic[1,8])
mmusichr <- aov(freq$m ~ freq$musichr) %>% anova_stats()
sqrt(mmusichr[1,8])
mwmusichr <- aov(freq$mw ~ freq$musichr) %>% anova_stats()
sqrt(mwmusichr[1,8])


ddish <- aov(freq$d ~ freq$dish) %>% anova_stats()
sqrt(ddish[1,8])
dwdish <- aov(freq$dw ~ freq$dish) %>% anova_stats()
sqrt(dwdish[1,8])
ddishhr <- aov(freq$d ~ freq$dishhr) %>% anova_stats()
sqrt(ddishhr[1,8])
dwdishhr <- aov(freq$dw ~ freq$dishhr) %>% anova_stats()
sqrt(dwdishhr[1,8])


ttraffic <- aov(freq$t ~ freq$traffic) %>% anova_stats()
sqrt(ttraffic[1,8])
twtraffic <- aov(freq$tw ~ freq$traffic) %>% anova_stats()
sqrt(twtraffic[1,8])
ttraffichr <- aov(freq$t ~ freq$traffichr) %>% anova_stats()
sqrt(ttraffichr[1,8])
twtraffichr <- aov(freq$tw ~ freq$traffichr) %>% anova_stats()
sqrt(twtraffichr[1,8])


vvacuum <- aov(freq$v ~ freq$vacuum) %>% anova_stats()
sqrt(vvacuum[1,8])
vwvacuum <- aov(freq$vw ~ freq$vacuum) %>% anova_stats()
sqrt(vwvacuum[1,8])
vvacuumhr <- aov(freq$v ~ freq$vacuumhr) %>% anova_stats()
sqrt(vvacuumhr[1,8])
vwvacuumhr <- aov(freq$vw ~ freq$vacuumhr) %>% anova_stats()
sqrt(vwvacuumhr[1,8])
