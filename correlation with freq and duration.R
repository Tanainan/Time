...
aov(freq$g ~ freq$game) %>% anova_stats()
aov(freq$gw ~ freq$game) %>% anova_stats()
aov(freq$g ~ freq$gamehr) %>% anova_stats()
aov(freq$gw ~ freq$gamehr) %>% anova_stats()

aov(freq$s ~ freq$sports) %>% anova_stats()
aov(freq$sw ~ freq$sports) %>% anova_stats()
aov(freq$s ~ freq$sportshr) %>% anova_stats()
aov(freq$sw ~ freq$sportshr) %>% anova_stats()

aov(freq$m ~ freq$music) %>% anova_stats()
aov(freq$mw ~ freq$music) %>% anova_stats()
aov(freq$m ~ freq$musichr) %>% anova_stats()
aov(freq$mw ~ freq$musichr) %>% anova_stats()

aov(freq$d ~ freq$dish) %>% anova_stats()
aov(freq$dw ~ freq$dish) %>% anova_stats()
aov(freq$d ~ freq$dishhr) %>% anova_stats()
aov(freq$dw ~ freq$dishhr) %>% anova_stats()

aov(freq$t ~ freq$traffic) %>% anova_stats()
aov(freq$tw ~ freq$traffic) %>% anova_stats()
aov(freq$t ~ freq$traffichr) %>% anova_stats()
aov(freq$tw ~ freq$traffichr) %>% anova_stats()

aov(freq$v ~ freq$vacuum) %>% anova_stats()
aov(freq$vw ~ freq$vacuum) %>% anova_stats()
aov(freq$v ~ freq$vacuumhr) %>% anova_stats()
aov(freq$vw ~ freq$vacuumhr) %>% anova_stats()
