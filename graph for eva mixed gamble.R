...
oo01gd <- ggplot(data = posigd, aes(x = Time, y = Proportion, group = type)) + 
  ...
  labs(linetype = "Evaluation Score Difference", title = "Dishes & Games", y = "", x = "")
...
oo01st <- ggplot(data = posist, aes(x = Time, y = Proportion, group = type)) + 
  ...
  theme_bw() + 
  scale_y_continuous(limits = c(0,1)) +
  labs(linetype = "Evaluation Score Difference", title = "Traffic Jam & Sports", y = "", x = "")
...
oo01mv <- ggplot(data = posimv, aes(x = Time, y = Proportion, group = type)) + 
  ...
  theme_bw() + 
  scale_y_continuous(limits = c(0,1)) +
  labs(linetype = "Evaluation Score Difference", title = "Vacuum & Music", y = "", x = "")



# Evaluation diff
figes <- ggarrange(oo01gd,oo01st,oo01mv, nrow = 3, common.legend = T, legend = "right")
annotate_figure(figes, top = text_grob("Risk-Aversion Proportions in Mixed Gamble \n Based on Evaluation Score Difference"),
